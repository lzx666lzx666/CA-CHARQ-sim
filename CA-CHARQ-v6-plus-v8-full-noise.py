...
if __name__ == "__main__":
    ...
    print(f" Channel: Thorp absorption (f={FREQ_KHZ}kHz, α≈{thorp_alpha(FREQ_KHZ):.1f}dB/km) + Rician K=2")
    ...
    plt.tight_layout()
    plt.savefig("v8_thorp_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] v8_thorp_Delay_Overhead.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("v8_thorp_EE.png", dpi=200, bbox_inches='tight')
    print("[OK] v8_thorp_EE.png")
    plt.close('all')
