...
if __name__ == "__main__":
    ...
    print(f" C-HARQ/C-ARQ: 1 pre-selected helper (midpoint); CA-CHARQ: 3-helper competition")
    print("=" * 65)
    ...
    plt.tight_layout()
    plt.savefig("v6-plus_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] v6-plus_Delay_Overhead.png")
    plt.close('all')
