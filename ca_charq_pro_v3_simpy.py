...
from ca_charq_pro_v3_analytic import (
    ...
    rs_decoded_ser, per_rs, per_rs_gaussian, compute_cpkt, _qpsk_to_rs_ser,
)
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("output/pro-v3/simpy_v3_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] output/pro-v3/simpy_v3_Delay_Overhead.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("output/pro-v3/simpy_v3_EE.png", dpi=200, bbox_inches='tight')
    print("[OK] output/pro-v3/simpy_v3_EE.png")
    plt.close('all')
