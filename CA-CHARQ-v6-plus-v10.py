...
if __name__ == "__main__":
    ...
    print(f" Channel: Rayleigh fading + Thorp α≈{thorp_alpha(FREQ_KHZ):.1f}dB/km + adaptive helper Tx power")
    ...
    plt.tight_layout()
    plt.savefig("output/v10_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] output/v10_Delay_Overhead.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("output/v10_EE.png", dpi=200, bbox_inches='tight')
    print("[OK] output/v10_EE.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("output/v10_Distance_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] output/v10_Distance_Delay_Overhead.png")
    plt.close('all')
