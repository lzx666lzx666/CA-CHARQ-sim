...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("output/max-v3/max-v3_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] output/max-v3/max-v3_Delay_Overhead.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("output/max-v3/v5_EE.png", dpi=200, bbox_inches='tight')
    print("[OK] output/max-v3/v5_EE.png")
    plt.close('all')
