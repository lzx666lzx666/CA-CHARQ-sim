...
if __name__ == "__main__":
    ...
    print(f" PHY: MIESM (3GPP NR) avg-MI→SNR_eff→BLER(code_rate)")
    print("=" * 65)
    ...
    plt.tight_layout()
    plt.savefig("v6-plus-v5_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] v6-plus-v5_Delay_Overhead.png")
    plt.close('all')
