    ...
    def handle(self, pkt):
        ...
        # ---- NACK 处理 ----
            ...
            if self.role == 'ROUTER' and pkt.hop_rx == self.node_id:
                ...
                # CA-CHARQ / CARQ: 退避竞争（每 helper 每 pid 最多 3 次）
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("v6_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig("v6_Throughput.png", dpi=200, bbox_inches='tight')
