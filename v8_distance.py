...
if __name__ == "__main__":
    ...
    print(f" Fixed noise: 0dB SNR at 600m, Hop distances: {HOP_DIST_LIST}m, Thorp α≈{thorp_alpha(FREQ_KHZ):.1f}dB/km @{FREQ_KHZ}kHz")
    ...
    plt.tight_layout()
    plt.savefig("v8_distance_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] v8_distance_Delay_Overhead.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("v8_distance_EE.png", dpi=200, bbox_inches='tight')
    print("[OK] v8_distance_EE.png")
    plt.close('all')
