...
if __name__ == "__main__":
    ...
    print(f" Channel: Thorp α≈{thorp_alpha(FREQ_KHZ):.1f}dB/km + adaptive helper Tx power")
    ...
    plt.tight_layout()
    plt.savefig("v9_Delay_Overhead_EE.png", dpi=200, bbox_inches='tight')
    print("\n[OK] v9_Delay_Overhead_EE.png")
    plt.close('all')
