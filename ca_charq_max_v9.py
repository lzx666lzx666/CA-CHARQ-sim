#!/usr/bin/env python3
"""
CA-CHARQ v9 — 15 helpers all protocols, single-sink topology
==============================================================
v8 baseline: single shared sink, _link_level() SNR-activated, GTO actual distance.
v9: 15 helpers for ALL protocols (CA same as C-HARQ/C-ARQ), fair resource comparison.
"""
...
# ==========================================
NUM_CHAINS       = 3
N_HELPERS_TOTAL  = 15   # v9: 15 helpers for all protocols
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print(f"  CA-CHARQ v9 — 15 helpers ALL | {N_RUNS} MC × {len(SNR_LIST)} SNR × {len(PROTOCOLS)} proto")
    ...
    ax1.set_title("CA-CHARQ v9 MAX — 3-Chain with MAC")
    ...
    plt.tight_layout()
    plt.savefig("output/max-v9/max-v9_Delay_Overhead.png", dpi=200, bbox_inches='tight')
    print("\n[OK] output/max-v9/max-v9_Delay_Overhead.png")
    plt.close('all')
    ...
    plt.tight_layout()
    plt.savefig("output/max-v9/max-v9_EE.png", dpi=200, bbox_inches='tight')
    print("[OK] output/max-v9/max-v9_EE.png")
    plt.close('all')

    print("=" * 60)
    print("CA-CHARQ v9 MAX with MAC Done.")
